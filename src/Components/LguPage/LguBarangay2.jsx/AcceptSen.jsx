      ...
      try {
        ...
        const acceptedApplicantsData = data.filter(
          (applicant) =>
            ...
            applicant.barangay === "Baybay Lopez"
        );
      ...
      <div className="bg-white py-4 px-6 rounded-lg">
        ...
        <div className="flex justify-center items-center flex-col mb-8">
          <h2 className="mt-1 font-semibold ">
            BARANGAY SENIOR CITIZEN'S ASSOCIATION
          </h2>
          <h2 className="mt-1 font-semibold ">Barangay Baybay Lopez</h2>
        ...
        <table className="w-full">
          <thead>
            <tr>
              ...
              <th className="border px-28 py-2">OSCA ID</th>
          ...
          <tbody>
            {acceptedApplicants.map((applicant, index) => (
              <tr key={applicant._id}>
                ...
                <td className="border px-4 py-2 text-center">{`${applicant.firstName} ${applicant.lastName}`}</td>
