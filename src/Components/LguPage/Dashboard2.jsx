...
const Dashboard2 = () => {
  ...
  return (
    <div className="pl-4 pr-4 pt-4 sm:pl-16 sm:pr-16">
      <h1 className="text-2xl font-bold mb-4">Dashboard</h1>
      <div className="grid grid-rows-2 gap-4 sm:grid-cols-1">
        <div className="font-bold text-lg border rounded-2xl shadow-xl">
          ...
          <div className="p-4 grid grid-cols-3 sm:grid-cols-4 gap-2 text-center">
