        ...
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center">
            <div className="">
              ...
              {showDropdown && (
                <div className="absolute right-0 mt-2 bg-white p-2 shadow-lg rounded-md mr-4">
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 pl-6">
          <div className="bg-white p-6 rounded-md shadow-md w-96">
            ...
            <button
              ...
              className="mt-6 bg-[#6D2932] text-white px-4 py-2 rounded-md hover:bg-indigo-600 transition-colors duration-300"
            >
              Close
            </button>
          </div>
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-b-lg p-4">
              ...
              <div className="flex mt-2">
                <button
                  type="submit"
                  className="border px-2 bg-[#6D2932]   rounded-sl text-white font-bold hover:bg-blue-800 py-1 mr-2"
                >
                  Submit
                </button>
                <button
                  onClick={handleCloseModal}
                  className="border px-2  bg-[#6D2932]   rounded-sl text-white font-bold hover:bg-blue-800 py-1"
                >
                  Close
                </button>
              </div>
