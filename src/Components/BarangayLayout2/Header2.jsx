    ...
    <>
      <header className="bg-white text-gray-400 py-4 drop-shadow-xl ">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center mb-2 md:mb-0">
            <h1 className="text-xl mr-4">Regional Admin</h1>
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 pl-6">
          <div className="bg-white p-6 rounded-md shadow-md w-96">
            ...
            <button
              ...
              className="mt-6 bg-indigo-500 text-white px-4 py-2 rounded-md hover:bg-indigo-600 transition-colors duration-300"
            >
              Close
            </button>
          </div>
      ...
      {showChangePasswordModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-500 bg-opacity-75 z-50">
          <div>
            <h1 className="text-2xl text-white bg-indigo-500  rounded-t-lg p-2">
              Change Password
            </h1>
            <form onSubmit={handleSubmit} className="bg-white rounded-b-lg p-4">
              ...
              <div className="flex mt-2">
                <button
                  type="submit"
                  className="border px-2  bg-indigo-500  rounded-sl text-white font-bold hover:bg-blue-800 py-1 mr-2"
                >
                  Submit
                </button>
                <button
                  onClick={handleCloseModal}
                  className="border px-2  bg-indigo-500  rounded-sl text-white font-bold hover:bg-blue-800 py-1"
                >
                  Close
                </button>
              </div>
